...
if __name__ == '__main__':
    ...
    for curDir,dirs,images in os.walk("images"):
        print("AAAAAAAAAAA",images)
    for image in images:
        print(image)
    ...
    #image = common.read_imgfile(args.image, None, None)
        ...
        showit=np.zeros((1024,768,3),np.uint8) #出力用に空の画像を作成

        image = TfPoseEstimator.draw_humans(showit, humans, imgcopy=False, frame=0, output_json_dir=args.output_json)
